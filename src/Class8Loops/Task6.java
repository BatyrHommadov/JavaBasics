...
public class Task6 {
    public static void main(String[] args) {
        /*
        Print out the table of 2 using a while loop
    ...
    Print out a message that says num +"x 2 =" product, where num is the current value of the loop variable and product is the product calculated in step 3.
    Increment num by 1.
    ...
    10 x 2 = 20
        ...
        int mult=2;
        while(num<=10){
            System.out.println(num+" x 2 = "+mult*num);
            num++;
        }
    }
}
