...
public class HW1 {
    ...
    After the message has been printed, the for loop will move on to the next element in the array and repeat
    the process until all elements have been printed
    */
